...
def mostrar_menu():
    ...
    unidades = {
        '1':'segundo semestres programacion/pythonProject3/.venv/semana 7.py'
        '2':'segundo semestres programacion/pythonProject8/.ven/orogramacion tradicional semana 3.py'
        '3':'segundo semestres programacion/semana 4/CLIENTE SEMANA 4.py'
        '4':'segundo semestres programacion/semana 4/RESERVAS SEMANA 4.py'
        '5':'segundo semestres programacion/semana 5/tipos de indentificadores semana 5.py'
        '6':'segundo semestresmprogramacion/clases,objetos semana 6/clases,objetos semana6.py'
